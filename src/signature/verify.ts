import { base64UrlToBytes, verifyMlDsa } from "@enclave/pqc-primitives";

import {
  buildCanonicalManifest,
  type ManifestDocumentInput,
  type ManifestRecipientInput,
} from "../manifest/canonical.js";
import type { RecipientSignaturePayload } from "./recipient.js";

export type { ManifestDocumentInput, ManifestRecipientInput };

export { buildCanonicalManifest };
